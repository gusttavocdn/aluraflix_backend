    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Video>().HasData(
            new Video()
            {
                ...
                Description =
                    "O anime mais injustiçado da temporada (na minha humilde opinião haha) voltou! Nier Automata 1.1a ep. 4 comentado em detalhes aqui pra vocês.",
            ...
            new Video()
            {
                ...
                Description =
                    "2V2  @prohooper4533    Nosso SEGUNDO desafio do grupo de racha, as próximas semanas, vou fazer um vídeo explicando o intuito dos novos desafio aqui do canal e do PRO HOOPER, espero que vocês gostem e até o próximo video familina, tmj!",
